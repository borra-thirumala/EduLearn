      ...
      <CardContent>
        <div className="space-y-4 mt-5">
          ...
          <div>
            ...
            <BasicTextEditor
              input={input} // Pass the entire courseData object as input
              setInput={setInput} // Pass the setCourseData function to update the state
            />
          </div>
